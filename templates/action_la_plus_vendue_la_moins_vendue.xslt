<xsl:template name="main">
	<div class="container">
		<h1>Liste de l'action la plus vendue et de la moins vendue sur une journée: </h1>
		<ul class="list-group">
...
<xsl:template match="/Actions">
	<li class="list-group-item">
		<h5>
			Action la plus vendue et action la moins vendue de la journée du 12-12-2015.
		</h5>
